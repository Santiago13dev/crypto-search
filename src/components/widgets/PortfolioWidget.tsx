        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-[#00ff00]/5 border border-[#00ff00]/20 rounded">
              ...
              <p className="text-lg font-mono font-bold text-[#00ff00]">
          ...
          <div className="space-y-2">
            {portfolio.slice(0, size === 'compact' ? 3 : 10).map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="flex items-center justify-between p-2 bg-[#00ff00]/5 border border-[#00ff00]/20 rounded hover:border-[#00ff00]/40 transition-colors"
                >
          ...
          {size === 'compact' && portfolio.length > 3 && (
            <p className="text-xs text-center text-[#00ff00]/50 font-mono">
