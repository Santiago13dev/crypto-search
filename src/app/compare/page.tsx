...
import { ScaleIcon, MagnifyingGlassIcon, XMarkIcon, TrophyIcon } from '@heroicons/react/24/outline';
...
export default function ComparePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0f1e] text-[#00ff00]">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold font-mono">{`>`} COMPARADOR</h1>
      </div>
    </main>
  );
}